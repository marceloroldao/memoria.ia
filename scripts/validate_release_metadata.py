...
CURRENT_ARCHIVAL_DOI = "10.5281/zenodo.22654141"
PREVIOUS_ARCHIVAL_DOI = "10.5281/zenodo.22648409"
CURRENT_PUBLIC_TAG = "v1.0.0-rc7"
...
def main() -> int:
    ...
    require(CURRENT_ARCHIVAL_DOI in readme, "README missing RC7 archival DOI")
    ...
    require(CURRENT_ARCHIVAL_DOI in notes, "RC7 release notes missing current archival DOI")
    ...
    require("The RC7 DOI was registered after publication" in notes, "RC7 DOI registration statement missing")
    ...
    print(f"rc7_doi={CURRENT_ARCHIVAL_DOI}")
    print("rc7_doi_registered=true")
    return 0

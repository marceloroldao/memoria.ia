...
def main() -> None:
    ...
    cases = [
        ...
        ("depositante quantia remete agencia", None, "context_alias_reordered"),
        ("agencia quantia remete depositante", None, "context_alias_reordered"),
        ("quantia remete depositante agencia", None, "context_alias_reordered"),

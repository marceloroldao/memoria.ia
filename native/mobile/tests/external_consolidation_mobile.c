...
int main(void) {
    ...
    CHECK(learn(h,
        "{\"content\":\"atlas code = 7319\",\"source_url\":\"https://one.example/a\","
    ...
    CHECK(learn(h,
        "{\"content\":\"atlas code = 7319\",\"source_url\":\"https://one.example/b\","
    ...
    CHECK(learn(h,
        "{\"content\":\"atlas code = 7319\",\"source_url\":\"https://two.example/a\","
    ...
    CHECK(learn(h,
        "{\"content\":\"atlas code = 9999\",\"source_url\":\"https://three.example/a\","
